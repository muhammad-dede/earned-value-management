<div class="card-body">
    <form>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="file_izin_kerja">
                        <code>File Izin Kerja</code>
                        &nbsp;|&nbsp;
                        <a href="{{ asset('assets/projek') }}/{{ $projek->file_izin_kerja }}"
                            target="_blank">{{ $projek->file_izin_kerja }}</a>
                    </label>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="file_izin_kerja">
                        <code>File Kontrak</code>
                        &nbsp;|&nbsp;
                        <a href="{{ asset('assets/projek') }}/{{ $projek->file_kontrak }}"
                            target="_blank">{{ $projek->file_kontrak }}</a>
                    </label>
