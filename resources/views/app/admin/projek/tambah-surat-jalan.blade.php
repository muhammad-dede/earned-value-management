                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('projek.upload-surat-jalan', $projek) }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="keterangan" id="keterangan" cols="30" rows="3"
                                            class="form-control rounded-0 @error('keterangan') is-invalid @enderror">{{ old('keterangan') }}</textarea>
                                        @error('keterangan')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="tgl_surat" type="date"
                                            ...
                                            id="tgl_surat" value="{{ old('tgl_surat') }}">
                                        @error('tgl_surat')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
