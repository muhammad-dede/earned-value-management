                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('vendor-pt.update', $vendor_pt) }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror"
                                            id="alamat" cols="30" rows="3">{{ $vendor_pt->alamat }}</textarea>
                                        @error('alamat')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="{{ url('assets/vendor-pt') }}/{{ $vendor_pt->logo }}"
                                            target="_blank">{{ $vendor_pt->logo }}</a>
