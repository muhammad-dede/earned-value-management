        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <a href="{{ route('user.index') }}" class="btn btn-danger float-sm-right">Kembali</a>
                    </div>
                </div>
            </div>
        </section>
                                ...
                                <form action="{{ route('user.update', $user) }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="tgl_lahir" type="date"
                                            ...
                                            id="tgl_lahir" value="{{ $user->tgl_lahir }}">
                                        @error('tgl_lahir')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror"
                                            id="alamat" cols="30" rows="3">{{ $user->alamat }}</textarea>
                                        @error('alamat')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                        ...
                                        <select name="id_jabatan" id="id_jabatan"
                                            ...
                                            @foreach ($data_jabatan as $jabatan)
                                                <option value="{{ $jabatan->id_jabatan }}"
                                                    {{ $user->id_jabatan == $jabatan->id_jabatan ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        <label for="file_ktp">
                                            <code>KTP</code> &nbsp;|&nbsp; <a
                                                href="{{ asset('assets/file-pegawai') }}/{{ $user->file_ktp }}"
                                                target="_blank">{{ $user->file_ktp }}</a>
                                        </label>
                                    ...
                                    <div class="form-group">
                                        <label for="file_asuransi">
                                            <code>Asuransi</code> &nbsp;|&nbsp; <a
                                                href="{{ asset('assets/file-pegawai') }}/{{ $user->file_asuransi }}"
                                                target="_blank">{{ $user->file_asuransi }}</a>
                                        </label>
                                    ...
                                    <div class="form-group">
                                        <label for="file_foto">
                                            <code>Pass Foto</code> &nbsp;|&nbsp; <a
                                                href="{{ asset('assets/file-pegawai') }}/{{ $user->file_foto }}"
                                                target="_blank">{{ $user->file_foto }}</a>
                                        </label>
                                    ...
                                    <div class="form-group">
                                        <label for="id_role"><code>Role</code></label>
                                        <select name="id_role" id="id_role"
                                            class="form-control rounded-0 @error('id_role') is-invalid @enderror">
                                            <option value="" selected></option>
                                            @foreach ($data_role as $role)
                                                <option value="{{ $role->id_role }}"
                                                    {{ $user->user->id_role == $role->id_role ? 'selected' : '' }}>
                                                    {{ $role->role }}</option>
                                            @endforeach
                                        </select>
                                        @error('id_role')
