                                ...
                                <form action="{{ route('pegawai.update', $pegawai) }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="jk" id="jk"
                                            ...
                                            <option value="L" {{ $pegawai->jk == 'L' ? 'selected' : '' }}>
                                                Laki-laki</option>
                                            <option value="P" {{ $pegawai->jk == 'P' ? 'selected' : '' }}>
                                                Perempuan</option>
                                        </select>
                                        @error('jk')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="tempat_lahir" type="text"
                                            ...
                                            id="tempat_lahir" value="{{ $pegawai->tempat_lahir }}">
                                        @error('tempat_lahir')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input name="tgl_lahir" type="date"
                                            ...
                                            id="tgl_lahir" value="{{ $pegawai->tgl_lahir }}">
                                        @error('tgl_lahir')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror"
                                            id="alamat" cols="30" rows="3">{{ $pegawai->alamat }}</textarea>
                                        @error('alamat')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="{{ url('assets/file-pegawai') }}/{{ $pegawai->file_ktp }}"
                                            target="_blank">{{ $pegawai->file_ktp }}</a>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="{{ url('assets/file-pegawai') }}/{{ $pegawai->file_asuransi }}"
                                            target="_blank">{{ $pegawai->file_asuransi }}</a>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="{{ url('assets/file-pegawai') }}/{{ $pegawai->file_foto }}"
                                            target="_blank">{{ $pegawai->file_foto }}</a>
